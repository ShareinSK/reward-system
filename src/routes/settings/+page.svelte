...
<section class="page">
	<header>
		...
		<h1>Settings</h1>
		<p class="lede">
			Tune scoring so the whole household stays clear — especially for younger kids.
		</p>
	</header>
		...
		<form class="panel" onsubmit={save}>
			...
			<label class="toggle">
				...
				<span>
					...
					<em>When off, scores stay whole numbers (1, 2, 5) — easier for kids to follow than 2.5.</em>
				</span>
			</label>
